...
export const metadata = {
  ...
  description:
    "Reserve su consulta legal online. Primera consulta sin cargo. Elija fecha y horario.",
};
        ...
        <div className="bg-navy-950 pt-24 pb-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-400">
              ...
              La primera consulta es <span className="text-gold-400 font-semibold">sin cargo</span>.
            </p>
          </div>
        </div>
